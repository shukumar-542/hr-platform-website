        ...
        // },
        {
          ...
          render: () => (
            <div className='flex items-center gap-2 text-white'>
              <button className='rounded-xs p-1 cursor-pointer bg-[#03346E]'><IoEyeOutline size={20} /></button>
              <button className='rounded-xs p-1 cursor-pointer bg-red-500'><CiEdit size={20} /></button>
            </div>
          ),
        },
      ];
